...
const ImageGallery = () => {
    ...
    return (
        <div>
            <h2 className='text-2xl text-red-600 text-center mb-4'>Graduate Gallery</h2>
            <div className='mt-10'>
                            ...
                            {toyImages.map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className="overlay">
                                        <p className="text-white absolute bottom-0 delay-150 left-0 p-4 w-full h-full hover:bg-black hover:bg-opacity-50">
                                            {item.text}
                                        </p>
                                    </div>
                                </div>
